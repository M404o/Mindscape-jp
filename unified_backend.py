...
@app.get("/diagnosis_jp.html", response_class=HTMLResponse)
async def serve_diagnosis():
    """診断画面HTML配信"""
    try:
        with open("diagnosis_jp.html", 'r', encoding='utf-8') as f:
            content = f.read()
        ...
        <p>diagnosis_jp.html が見つかりません</p>
        <p>ファイルがルートディレクトリにあるか確認してください</p>
        </body></html>
        """)
...
async def serve_analysis():
    ...
    try:
        ...
        return HTMLResponse("""
        <html><body>
        <h1>分析ファイルが見つかりません</h1>
        <p>analysis.html が見つかりません</p>
        </body></html>
        """)
...
async def serve_root():
    ...
    <ul>
        ...
        <li><a href="/diagnosis_jp.html">📝 診断開始</a></li>
        <li><a href="/light_results.html">📊 結果画面</a></li>
        <li><a href="/analysis.html">📈 分析画面</a></li>
    </ul>
    </body></html>
    """)
